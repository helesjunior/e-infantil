...
class RoleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setRoute('/administracao/grupo');

        // deny access according to configuration file
        if (!backpack_user()->can('administracao_habilitacao_grupo_criar')) {
            $this->crud->denyAccess('create');
        }
        if (!backpack_user()->can('administracao_habilitacao_grupo_editar')) {
            $this->crud->denyAccess('update');
        }
        if (!backpack_user()->can('administracao_habilitacao_grupo_deletar')) {
